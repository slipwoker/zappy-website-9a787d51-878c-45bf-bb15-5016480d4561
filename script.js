document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      const isRequired =
        field.hasAttribute('required') || field.getAttribute('data-required') === 'true';
      ...
      if (value.trim() !== '') {
        if ((type === 'email' || field.getAttribute('data-validate') === 'email') &&
          !VALIDATORS.email(value)) {
          showFieldError(field, getErrorMessage(field, 'email'));
          return false;
        }

        if ((type === 'tel' || field.getAttribute('data-validate') === 'tel') &&
          !VALIDATORS.tel(value)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "השקעות על רמה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9a787d51-878c-45bf-bb15-5016480d4561',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9a787d51-878c-45bf-bb15-5016480d4561';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9a787d51-878c-45bf-bb15-5016480d4561';
